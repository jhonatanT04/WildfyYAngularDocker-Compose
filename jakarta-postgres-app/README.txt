...
a persistence unit "jakarta-postgres-appPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "jakarta-postgres-app/pom.xml":
...
artifact ("jakarta-postgres-app.war") is already built. You can build
